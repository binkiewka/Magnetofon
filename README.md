...
- **Program Memory (`PlaylistPanel`)**: Music and video queue with native system file dialog and drag-and-drop loading.
...
sudo apt install build-essential cmake qt6-base-dev qt6-declarative-dev qt6-tools-dev \
  libmpv-dev libpulse-dev libavformat-dev libavcodec-dev libavutil-dev libx11-dev pkg-config
```
